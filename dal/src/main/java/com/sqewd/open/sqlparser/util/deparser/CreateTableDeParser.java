...
import com.sqewd.open.sqlparser.statement.create.table.ColumnDefinition;
import com.sqewd.open.sqlparser.statement.create.table.CreateTable;
import com.sqewd.open.sqlparser.statement.create.table.Index;
...
public class CreateTableDeParser {
	 ...
	 */
	public CreateTableDeParser(final StringBuffer buffer) {
		this.buffer = buffer;
	}
