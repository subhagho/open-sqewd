 ...
 * 
 */
public class SqlIntType extends SqlDataType<Integer> implements
		SchemaNumericDatatype<Integer> {
	 ...
	 * , java.lang.Object)
	 */
	public Integer mod(final Integer source, final Integer value) {
	 ...
	 * , java.lang.Object)
	 */
	public Integer pow(final Integer source, final Integer value) {
		return (int) Math.pow(source, value);
	}
