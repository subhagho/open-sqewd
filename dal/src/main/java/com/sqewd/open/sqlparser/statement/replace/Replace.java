...
package com.sqewd.open.sqlparser.statement.replace;
...
public class Replace implements Statement {
	...
	/**
	 * A list of {@link net.sf.jsqlparser.schema.Column}s either from a
	 * "REPLACE mytab (col1, col2) [...]" or a
	...
	public void setColumns(final List list) {
		columns = list;
	}
	...
	public void setExpressions(final List list) {
		expressions = list;
	}
